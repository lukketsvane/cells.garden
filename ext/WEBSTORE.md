...
- Publisher: `iverfinne`
- Current replacement release: `0.1.2`
...
The original 0.1.0 submission entered review on 18 September 2026. When 0.1.2 is ready:
...
3. On **Package**, upload the 0.1.2 ZIP. `manifest.json` must be at the ZIP root.
4. Re-check Store listing and Privacy practices against the copy below.
5. Submit the 0.1.2 revision for review.
